...
plot_path = path.join(workspace_path, "paper", "images", "light_dark_1d_x3_decomposed")
...
plot_image(
    ...
    filename="light_dark_1d_x3",
    legend_labels=["Total", "Bulge", "Disk", "Envelope", "Dark Matter", None, None],
)
...
plot_image(
    ...
    filename="light_dark_1d_x3_grad",
    legend_labels=["Total", "Bulge", "Disk", "Envelope", "Dark Matter", None, None],
)
...
plot_image(
    ...
    search_name=search_name,
    envelope_cls=al.mp.EllSersic,
    filename="light_dark_1d_x3_smbh",
    legend_labels=["Total", "Bulge", "Disk", "Envelope", "Dark Matter", None, None],
)
...
plot_image(
    ...
    search_name=search_name,
    envelope_cls=al.mp.EllSersicRadialGradient,
    filename="light_dark_1d_x3_grad_smbh",
    legend_labels=["Total", "Bulge", "Disk", "Envelope", "Dark Matter", None, None],
)
